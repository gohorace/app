...
import { ArrowUpRight, Calendar, Lightbulb, Mail, MessageCircle } from 'lucide-react'
 ...
 * CTA, a two-column Guides × Talk-to-a-human grid, and a moss status strip.
 * Guides link out to the Featurebase Help Centre. Static config from
 * lib/support/status.ts; a live status feed is HOR-261 (v2-D8).
 */
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(min(260px, 100%), 1fr))', gap: 18 }}>
          ...
          <section style={panelStyle}>
            ...
            >
              ...
              <ArrowUpRight style={{ width: 13, height: 13, flexShrink: 0 }} aria-hidden />
            </a>
          </section>
