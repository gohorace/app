...
// HOR-282/294: host-aware, like /privacy. The neutral Doorstep host gets a
// brand-free contact page + neutral chrome; the marketing host gets the Horace
// one (which also fixes the pre-existing broken "Get in touch" link on the
// landing page — app/page.tsx linked /contact but no route existed).
export function generateMetadata(): Metadata {
  if (isDoorstepHost(headers().get('host'))) {
    return { ...neutralChrome, title: 'Contact', description: 'How to reach Doorstep.' }
  }
