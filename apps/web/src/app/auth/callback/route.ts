...
import { destinationForUser } from '@/lib/auth/post-auth-redirect'
...
export async function GET(request: NextRequest) {
  ...
  // Route the established session: onboarding for first-time signup, /signup
  // for a stale link with no pending workspace, else the requested target.
